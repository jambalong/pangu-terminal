...
ActiveRecord::Schema[8.1].define(version: 2026_04_04_185827) do
  ...
  create_table "api_keys", force: :cascade do |t|
    ...
    t.string "token", null: false, comment: "SHA-256 digest of the raw token"
  ...
  create_table "materials", force: :cascade do |t|
    ...
    t.integer "rarity", default: 1, null: false
    t.datetime "updated_at", null: false
    t.index ["item_group_id"], name: "index_materials_on_item_group_id"
  end
